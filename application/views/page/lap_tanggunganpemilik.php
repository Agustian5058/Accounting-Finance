    ...
    <section class="content">
      ...
      <?php if ($view == 'data') { ?>
        ...
        <div class="box">
          <div class="box-header">
            <h4>&nbsp;<i class="fa fa-book"></i>&nbsp;&nbsp;<b>Laporan Tanggungan Pemilik Periode <font style="color: red"><?=$periode?></font></b> </h4>
            <div class="box-tools pull-right">
              <form method="POST"  action="<?php echo site_url('index.php/admin/lap_tanggunganpemilik/generate/excel'); ?>">
              <input type="hidden" name="tgl_awal" value="<?=$excel['tgl_awal']?>">
              <input type="hidden" name="tgl_akhir" value="<?=$excel['tgl_akhir']?>">
              <input type="hidden" name="pemilik" value="<?=$excel['pemilik']?>">
      ...
      <?php if ($view == 'form') { ?>
        ...
        <div class="box box-primary">
          ...
          <!-- /.box-header -->
          <!-- form start -->
          <form role="form" method="POST" action="<?php echo site_url('index.php/admin/lap_tanggunganpemilik/generate'); ?>" class="form-horizontal">
            <div class="box-body">
              ...
              <div class="form-group">
                ...
                <div class="col-md-7">
                  <select name="pemilik" class="form-control select2" style="width: 100%;" required>
